...
- 🔍 **エピソード検索** — タイトル・概要をキーワードでリアルタイム絞り込み
- 📄 **段階表示** — 最新12件を初期表示し「もっと見る」で追加ロード
- 📣 **最新話ヒーロー表示** — トップのヒーローに最新エピソードのタイトル・日付を表示
- 💬 **感想・テーマ募集フォーム** — リスナーからメッセージを受け取り、管理画面で確認（年月別閲覧対応）
- 🔒 **管理画面認証** — サーバーサイドでのアクセス制御・ブルートフォース対策済み
- 🌐 **OGP対応** — X・LINE等でURLシェア時にタイトル・説明入りカードを表示
